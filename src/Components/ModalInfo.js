            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                    <Form>
                        ...
                        <Form.Group className="mb-3">
                            <Form.Label>Youtube Trailer Embed Code</Form.Label>
                            <Form.Control type="text" ref={embedIdRef} />
                        </Form.Group>
                    </Form>
                </Modal.Body>
                <Modal.Footer>
                    ...
                    <Button variant="success" onClick={() => {
                        return (
                            (titleRef.current.value && descRef.current.value && embedIdRef.current.value && posterUrlRef.current.value && ratingRef.current.value &&
                                (props.renderNewList([...props.oldMovies, {
                                    ...
                                    embedId: embedIdRef.current.value,
                                }])), handleClose()
                            )
                        )
                    }}>
